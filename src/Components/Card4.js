          ...
          <CardBody>
            ...
            <CardText className="text2">
              <ul>
                ...
                <li className="text2">
                    To acelerate the recycling, the <b className="text-primary"> ScrapYard </b> are going to manage Pune city's huge garbage dumps at 4 Material Recovery Facilities commonly known as MRF centers. Where everyday, more than 50 kgs of waste are segregated by our waste workers.     
                </li>
